...
public class Restaurante {
	...
	public Restaurante(String title, String description, String details, String thumbnail, String thumbnailbig, String map) {
		super();
		this.title = title;
	...
	public String toString() {
		return "Restaurante [id=" + id + ", title=" + title + ", descripcion=" + description + "]";
	}
